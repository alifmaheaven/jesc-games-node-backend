...
// controllers
import optionsControllers from '../controllers/optionsControllers';
...
router.get('/', JWTAuthentication, async (req: Request, res: Response) => {
  try {
    const result = await new optionsControllers().getData(req, req.query);
...
router.post('/', JWTAuthentication, async (req: Request, res: Response) => {
  try {
    const result = await new optionsControllers().createData(req, req.body);
...
router.put('/', JWTAuthentication, async (req: Request, res: Response) => {
  try {
    const result = await new optionsControllers().updateData(req, req.body);
...
router.delete('/', JWTAuthentication, async (req: Request, res: Response) => {
  try {
    const result = await new optionsControllers().deleteData(req, req.body);
...
router.post('/upload', JWTAuthentication, upload.array('files'), async (req: Request, res: Response) => {
  try {
    const result = await new optionsControllers().uploadFile(req);
...
router.delete('/upload', JWTAuthentication, async (req: Request, res: Response) => {
  try {
    const result = await new optionsControllers().deleteFile(req, req.body);
